 ...
 * @author Ben
 */
public class Trainer extends Parties
{
    Trainer(String usr, char[] pass, String nme, String dob, String secAns, String mail){
        username = usr;
        name = nme;
        password = pass;
    ...
    void addNewTrainer(Trainer trnr) throws Exception {
        try{
            MySQLAccess();
            String passwordHash = generatePasswordHash(trnr.password);
           
            preparedStatement = connect
                    .prepareStatement("INSERT INTO gym_app.trainers_owners"
                            + " VALUES (?, ?, ?, ?, ?, ?, ?)");
            preparedStatement.setString(1, trnr.username);
            preparedStatement.setString(2, passwordHash);
            preparedStatement.setString(3, trnr.name);
            preparedStatement.setString(4, trnr.dobString);
            preparedStatement.setString(5, trnr.securityAnswer);
            preparedStatement.setString(6, "Trainer");
            preparedStatement.setString(7, trnr.email);
    ...
    void updateTrainer(String name, String dob, String secAns, String email) throws Exception{
        try{
            MySQLAccess();
